This is a stripped version of emotion-detector.js used to identify the use of the Affinity Platform to build Machine Learning and Image Analysis Pipeline.
